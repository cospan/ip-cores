...
* ``tb_axi_lite_slave``: Testbench interface, primarily used to translate
    the cocotb AXI Lite bus signals to the signals within ``demo_axi_streams`` core.

* ``demo_axi_streams``: demo_axi_streamsnstration module, anyone who wishes to interact
